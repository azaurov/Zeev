...
_AGENT_SYSTEM = (
    ...
    "inside a file. You cannot modify files. When Alex asks to read, show or open a "
    "file, call read_file and give its contents; do not just list the folder or ask "
    "permission first, and do not repeat an earlier answer. Secrets (API keys, .env files, "
